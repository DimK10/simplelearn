                            ...
                            <div className="card mb-4">
                                {
                                    ...
                                    <span key={question.id + 1} className="border border-5 border-success rounded"
                                          onClick={toggleDifficultyClick}></span>
                                }
                                {
                                    question.difficulty === 'medium' &&
                                    <span key={question.id + 1}  className="border border-5 border-warning rounded"
                                          onClick={toggleDifficultyClick}></span>
                                }
                                {
                                    question.difficulty === 'hard' &&
                                    <span key={question.id + 1}  className="border border-5 border-danger rounded"
                                          onClick={toggleDifficultyClick}></span>
                                }
                                <div className="card-header py-3">
                                    <div className="row position-relative">
                                        <h5 className="mb-0 text-center mb-5"><strong>Question
                                            #{questions.indexOf(question) + 1}</strong></h5>
                                ...
                                <div className="card-body">
                                    {
                                        ...
                                        answers.length > 0
                                            ...
                                            :
                                            <h5 className="text-center">No answers Added! Press the plus button to add a
                                                new
                                                question</h5>
                                    }
                                    <div className="row">
